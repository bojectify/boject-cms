  ...
  builder.queryType({
    fields: (t) => ({
      ...
      positions: t.prismaConnection({
        type: 'Position',
        cursor: 'id',
        args: { where: t.arg({ type: filters.PositionWhere }) },
        resolve: (query, _root, args) =>
      ...
      seasons: t.prismaConnection({
        type: 'Season',
        cursor: 'id',
        args: { where: t.arg({ type: filters.SeasonWhere }) },
        resolve: (query, _root, args) =>
      ...
      teams: t.prismaConnection({
        type: 'Team',
        cursor: 'id',
        args: { where: t.arg({ type: filters.TeamWhere }) },
        resolve: (query, _root, args) =>
      ...
      clubs: t.prismaConnection({
        type: 'Club',
        cursor: 'id',
        args: { where: t.arg({ type: filters.ClubWhere }) },
        resolve: (query, _root, args) =>
      ...
      authors: t.prismaConnection({
        type: 'Author',
        cursor: 'id',
        args: { where: t.arg({ type: filters.AuthorWhere }) },
        resolve: (query, _root, args) =>
      ...
      tagGroups: t.prismaConnection({
        type: 'TagGroup',
        cursor: 'id',
        args: { where: t.arg({ type: filters.TagGroupWhere }) },
        resolve: (query, _root, args) =>
      ...
      links: t.prismaConnection({
        type: 'Link',
        cursor: 'id',
        args: { where: t.arg({ type: filters.LinkWhere }) },
        resolve: (query, _root, args) =>
      ...
      navigations: t.prismaConnection({
        type: 'Navigation',
        cursor: 'id',
        args: { where: t.arg({ type: filters.NavigationWhere }) },
        resolve: (query, _root, args) =>
